                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b bg-muted/40">
                                    ...
                                    <th className="text-left font-medium text-muted-foreground px-3 py-2.5 text-xs whitespace-nowrap">No. of Grantees Liquidated</th>
                                    <th className="text-left font-medium text-muted-foreground px-3 py-2.5 text-xs whitespace-nowrap">Amount Liquidated</th>
                                    <th className="text-left font-medium text-muted-foreground px-3 py-2.5 text-xs whitespace-nowrap">Amount Refunded</th>
                                    <th className="text-left font-medium text-muted-foreground px-3 py-2.5 text-xs whitespace-nowrap">Refund OR No.</th>
                                    <th className="text-right font-medium text-muted-foreground px-3 py-2.5 text-xs whitespace-nowrap">Total Liquidated Amount</th>
                                    <th className="text-right font-medium text-muted-foreground px-3 py-2.5 text-xs whitespace-nowrap">Unliquidated Amount</th>
